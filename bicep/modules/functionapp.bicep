...
@description('Foundry project connection that stores the MCP webhook credential (Custom keys type)')
param foundryMcpConnectionId string = ''
  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        {
          name: 'Foundry__McpConnectionId'
          value: foundryMcpConnectionId
        }
        {
